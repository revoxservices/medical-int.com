                      ...
                      <div class="row clearfix">
                        <div class="col-sm-12">
                          <div class="form-group form-group-default required">
                            <label>Nombres</label>
                            {!! Form::text('label', $faq->label, ['class' => 'form-control' . ($errors->has('label') ? ' is-invalid' : ''), 'required']) !!}
                          </div>
                        </div>
                        <div class="col-sm-12">
                          <div class="form-group form-group-default required">
                            <label>Posición</label>
                            {!! Form::text('position', $faq->position, ['class' => 'form-control' . ($errors->has('position') ? ' is-invalid' : ''), 'required']) !!}
                          </div>
                        </div>
                      </div>
                      <div class="row clearfix">
