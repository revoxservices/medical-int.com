                          ...
                          <div class="tab-content">
                            ...
                            <div class="pane padding-20 sm-no-padding">
                              ...
                              <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                  <a href="{{ route('manager.teams') }}">Equipo</a>
                                </li>
                              ...
                              <div class="row row-same-height">
                                <div class="col-md-12">
                                  ...
                                  {!! Form::open([
                'route' => ['manager.teams.update', $team->slack],
                'method' => 'POST',
                'id' => 'formTeam',
                'files' => true,
                                        ...
                                        <div class="row clearfix">
                                          <div class="col-sm-6">
                                            <div class="form-group form-group-default required">
                                              <label>Nombres</label>
                                              {!! Form::text('firstname', $team->firstname , ['class' => 'form-control' . ($errors->has('firstname') ? ' is-invalid' : ''), 'required']) !!}
                                            </div>
                                          </div> 
                                          <div class="col-sm-6">
                                            <div class="form-group form-group-default required">
                                              <label>Apellidos</label>
                                              {!! Form::text('lastname', $team->lastname , ['class' => 'form-control' . ($errors->has('lastname') ? ' is-invalid' : ''), 'required']) !!}
                                            </div>
                                          </div>
                                          <div class="col-sm-6">
                                            <div class="form-group form-group-default required">
                                              <label>Cargo</label>
                                              {!! Form::text('charger', $team->charger , ['class' => 'form-control' . ($errors->has('charger') ? ' is-invalid' : ''), 'required']) !!}
                                            </div>
                                          </div>
                                          <div class="col-md-6">
