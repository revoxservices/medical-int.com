                    ...
                    <div class="header__menu header__menu4 pl-60">
                        <nav id="mobile-menu">
                            <ul>
                                ...
                                <li><a href="{{ route('solutions') }}">Soluciones +</a>
                                    <ul class="submenu">
                                        <li><a href="{{ route('medicalcloud') }}">Medical Cloud</a></li>
                                    </ul>
                                </li>
                ...
                <div class="col-xl-4 col-lg-9 col-md-9 d-none d-xl-block">
                    <div class="header-right d-flex align-items-center justify-content-end">
                        ...
                        <div class="header-button pl-50 pt-30">
                            <a data-animation="fadeInLeft" data-delay=".6s" href="{{ route('impacts') }}" class="btn btn-icon ml-0" style="animation-delay: 0.6s;" tabindex="0">Proyecto de impacto social en salud</a>
