...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::get('/contact', 'Pages\ContactsController@index')->name('contacts');
    ...
    Route::get('/contact/success/{slug}', 'Pages\ContactsController@success')->name('contact.success');
    Route::post('/contact/storage', 'Pages\ContactsController@storage')->name('contact.store');
...
Route::prefix('manager')->namespace('Managers')->as('manager.')->group(function () {
    //-------------------------------------DASHBOARD--------------------------------------------//
    ...
    Route::post('/faqs/update', 'FaqsController@update')->name('faqs.update');
...
Route::prefix('manager')->namespace('Managers')->as('manager.')->group(function () {
    ...
    Route::post('/blog/storage', 'BlogsController@storage')->name('blogs.storage');
    Route::get('/blog/edit/{slack}', 'BlogsController@edit')->name('blogs.edit');
    Route::post('/blog/update/{slack}', 'BlogsController@update')->name('blogs.update');
    Route::get('/blog/destroy/{slack}', 'BlogsController@destroy')->name('blogs.destroy');
    ...
    Route::get('/users/view/{slack}', 'UsersController@view')->name('view.users');
    Route::get('/users/edit/{slack}', 'UsersController@edit')->name('edit.users');
    Route::post('/users/update', 'UsersController@update')->name('update.users');
    Route::get('/users/destroy/{slack}', 'UsersController@destroy')->name('destroy.users');
