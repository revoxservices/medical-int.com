...
class ImpactsController extends Controller
{
    ...
    public function index()
    {
        ...
        $blogs = Blog::available()->filters("impacts")->get()->take(3);
        $partners = Partner::available()->get();

        return view('pages.views.impacts.index')->with([
            'blogs' => $blogs,
            'partners' => $partners,
        ]);
    }
    ...
    public function piloto()
    {
        ...
        return view('pages.views.impacts.piloto')->with([]);
    }




    public function teleecografía()
    {
        ...
        return view('pages.views.impacts.teleecografía')->with([]);
    }




    public function rurales()
    {
        ...
        return view('pages.views.impacts.rurales')->with([]);
    }
}